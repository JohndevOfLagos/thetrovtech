...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  sessionStorage.setItem("appsuite_login_email", email.trim());


  setTimeout(() => {
    setLoading(false);
    navigate("/appsuite-login/password", { state: { email: email.trim() } });
  }, 600);
};
...
export default AppSuiteLoginEmail;